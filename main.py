...
bot = Client("bot",
             bot_token= "6711385952:AAHh6_HrAFPU6qZeYXfXv__CDt-v2EdJq2U",
             api_id=25957229,
             api_hash= "f19e0303f0d218f1744a28b826b7dc96")
...
async def account_login(bot: Client, m: Message):
    ...
    if input.document:
        ...
        await bot.send_document(-1001998669407, x)
            ...
            try:                               
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1001998669407)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
